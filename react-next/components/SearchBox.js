...
class SearchBox extends Component {
  ...
  onMenuChange = (value) => {
	...
	render() {
		const {path,hasnoGoods,isLoading,history,clearSearchList,clearGoodsList,tags} = this.props
      ...
      <div style={{ position: 'absolute', width: '100%', height: menuH * 0.6, display: 'flex', justifyContent: 'center' }}>
		...
		return (
			<SearchWrapper>
			 <HeaderWrapper>
				  <div>
						<img className="logo-img" src="https://cdn.yesdat.com/BAAAAAAAAJ8Bb4lSIC1RrF9zn.png"/>
					</div>
